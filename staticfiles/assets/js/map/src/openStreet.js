// =========================== Open Street Map (showed map)===========================
// document.addEventListener('DOMContentLoaded', function () {
//     // Initialize map with existing or default location
...
//
//     // const map = L.map('osmMap').setView([initialLat, initialLng], initialZoom);
...
//
//         // If place name provided, use it directly
//         if (placeName) {
//             document.getElementById('displayCity').textContent = placeName;
//             document.getElementById('mapCity').value = placeName;
//             return;
//         }
//
//         // Reverse geocode for city detection (only if no placeName)
...
// Listen to wheel events over the map
    ...
    function setLoadingState(loading) {
        ...
        saveBtn.textContent = loading ? "Loading location..." : "Save changes";
    }
