...
# DASHBOARD STAFF   ---------------------------------------------------------------------------------------------
class DSTFHome(LoginRequiredMixin, TemplateView):
...
class DSTFReview(LoginRequiredMixin, ListView):
    template_name = 'app_staff/dashboard/dstf_review.html'
    model = Review


class DSTFCourseList(LoginRequiredMixin, ListView):
    template_name = 'app_staff/dashboard/dstf_course_list.html'
    model = Tutor  # Must change to Course


class DSTFCourseCategory(LoginRequiredMixin, ListView):
    template_name = 'app_staff/dashboard/dstf_course_category.html'
    model = Tutor  # Must change to Course


class DSTFCourseDetail(LoginRequiredMixin, DetailView):
    template_name = 'app_staff/dashboard/dstf_course_list.html'
    model = Tutor  # Must change to Course


class DSTFStudentList(LoginRequiredMixin, ListView):
    template_name = 'app_staff/dashboard/dstf_student_list.html'
    model = Student


class DSTFTutorList(LoginRequiredMixin, ListView):
    template_name = 'app_staff/dashboard/dstf_tutor_list.html'
    model = Tutor


class DSTFTutorDetail(LoginRequiredMixin, DetailView):
...
class DSTFTutorRequest(LoginRequiredMixin, ListView):
    template_name = 'app_staff/dashboard/dstf_tutor_request.html'
    model = Tutor


class DSTFEdit(LoginRequiredMixin, View):
