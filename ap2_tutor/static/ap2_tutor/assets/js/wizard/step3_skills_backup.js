document.addEventListener('DOMContentLoaded', function () {
    ...
    // Get the hidden input value and convert Django's 'True'/'False' to JS boolean
    const isVip = isVipInput ? isVipInput.value.toLowerCase() === 'true' : false;
    const maxSkills = isVip ? 5 : 3; // Set max skills limit based on VIP status
    ...
    document.getElementById('btnSubmitSkills').addEventListener('click', function (e) {
        // document.querySelectorAll('.btnSubmitSkills').addEventListener('click', function (e) {
        e.preventDefault();
...
// ======================== Generate Review-Step Skills Table ========================
    ...
    // Initialize on load
    showAllExistedSkills(); // Initialize with existed skills
    addBlankSkillRow(); // Initialize with one row
    initSelects();
    initTooltips();
    // generateReviewStepSkills();
